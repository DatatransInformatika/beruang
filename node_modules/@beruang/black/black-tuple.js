...
class BlackTuple extends PolymerElement {
  static get template() {
    return html`
      <style>
        :host {
...
window.customElements.define('black-tuple', BlackTuple);
