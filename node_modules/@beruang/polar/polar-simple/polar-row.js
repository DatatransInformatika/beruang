...
import {PolarSimpleBehavior} from './polar-simple-behavior.js';
import './polar-simple-style.js';
...
@polymer
*/
class PolarRow extends PolarSimpleBehavior(PolarBehavior(BrownMaskBehavior(BeruangBehavior(PolymerElement)))) {
  static get template() {
    return html`
