...
import {BrownResizeMonitorBehavior} from '@beruang/brown/brown-resizemonitor/brown-resizemonitor-behavior.js';
...
@polymer
*/
class BrownTabDesktop extends BrownTabBehavior(
  ...
  _getContentByDataTab(tabId) {//v
    let fCheck = (el)=>{
      let data = el.nodeName!="BROWN-TABITEM-DESKTOP" ? el.getAttribute("data-tab") : null;//nyari tag konten
      return tabId==data;
    };
