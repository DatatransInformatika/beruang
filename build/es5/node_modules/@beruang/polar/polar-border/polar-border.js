...
minSize=this.get(this._region.id+"MinHeight");size=Math.max(size,minSize);//apply height
this._region.style.height=size+"px";break;case"west":case"east":offset=event.detail.dx*("east"==this._region.id?-1:1);size=this._regionSize+offset;//consider centerMinWidth
