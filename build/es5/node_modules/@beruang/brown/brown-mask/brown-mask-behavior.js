...
*/var internalBrownMaskBehavior=function internalBrownMaskBehavior(base){return(/*#__PURE__*/function(_base){babelHelpers.inherits(_class,_base);function _class(){babelHelpers.classCallCheck(this,_class);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(_class).apply(this,arguments))}babelHelpers.createClass(_class,[{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(_class.prototype),"ready",this).call(this);var el=this.shadowRoot.querySelector("slot[name=\"mask\"]");if(!el){var slot=document.createElement("slot");slot.setAttribute("name","mask");this.shadowRoot.appendChild(slot)}}},{key:"_onMask",value:function _onMask(mask,message){if(mask){if(!this._masker){this._masker=document.createElement("brown-mask");this.appendChild(this._masker)}this._masker.message=message}else{if(this._masker){this.removeChild(this._masker);delete this._masker}}}}],[{key:"properties",get:function get(){return{/** Show masker.
			@type{Boolean}
			*/mask:{type:Boolean,value:!1},/** Masker label.
			@type{String}
			*/maskMessage:{type:String}}}},{key:"observers",get:function get(){return["_onMask(mask, maskMessage)"]}}]);return _class}(base))},BrownMaskBehavior=(0,_mixin.dedupingMixin)(internalBrownMaskBehavior);_exports.BrownMaskBehavior=BrownMaskBehavior});