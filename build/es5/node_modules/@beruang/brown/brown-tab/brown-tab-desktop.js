...
this.addEventListener("active-changed",function(e){var tabItem=e.target;if("static"==_this.content){var content=_this._getContentByDataTab(tabItem.id);//tabItem.id "item1", "item2", "item3", etc...
...
},{key:"_getTabItemSibling",value:function _getTabItemSibling(el/*tab item*/,callback/*fungsi berisi syarat pencarian*/){var f=function f(sib){return"BROWN-TABITEM-DESKTOP"==sib.nodeName&&(//syarat 1: sibling harus <brown-tab-desktop></brown-tab-desktop>
...
},{key:"_removeDynamicContent",value:function _removeDynamicContent(){//hanya ada satu div content jika content=="dynamic"
var fCheck=function fCheck(el){return"content"==el.slot},content=this._getLightDOM(this.firstElementChild,!0,fCheck);if(content){this.removeChild(content)}}},{key:"_requestDynamicContent",value:function _requestDynamicContent(id){var fDecorator=function fDecorator(el){el.slot="content"};this.dispatchEvent(new CustomEvent("dynamic-content",//konstruksi event argument 1: nama event
...
}}}},{key:"_postScroll",value:function _postScroll(e){var tabItem=this._getLightDOM(this.lastElementChild,!1,function(el){//search last tabItem
