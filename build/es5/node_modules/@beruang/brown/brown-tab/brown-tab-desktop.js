...
var other=_this._getTabItemSibling(tabItem,null/*no criteria*/);//cari sibling tanpa periksa aktif atau tidak
if(other){//jika ada
...
this.addEventListener("active-changed",function(e){var tabItem=e.target,content=_this._getContentByDataTab(tabItem.id);//tabItem.id "item1", "item2", "item3", etc...
