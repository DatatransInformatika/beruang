define(["../../../@polymer/polymer/polymer-element.js","../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js","../../../@polymer/iron-flex-layout/iron-flex-layout.js","../../../@webcomponents/shadycss/entrypoints/apply-shim.js","../../beruang-behavior.js","../brown-behavior.js","../brown-mask/brown-mask-behavior.js","./brown-tab-behavior.js","./brown-tab-style.js"],function(_polymerElement,_gestureEventListeners,_ironFlexLayout,_applyShim,_beruangBehavior,_brownBehavior,_brownMaskBehavior,_brownTabBehavior,_brownTabStyle){"use strict";function _templateObject_1ebf8330995811e997b8915918243d9d(){var data=babelHelpers.taggedTemplateLiteral(["\n      <style  include=\"brown-tab-style\">\n        :host > #content > ::slotted([slot=content]) {\n          display:none;\n        }\n        /*content ada di dlm slot ditampilkan jika ada .content-active*/\n        :host > #content > ::slotted(.content-active) {\n          display:block;/*membatalkan display none*/\n        }\n      </style>\n      <div id=\"header\">\n        <iron-icon icon=\"chevron-left\" id=\"pre-scroll\" class=\"scroller\" on-tap=\"_preScroll\"></iron-icon>\n        <div id=\"header-item\"><slot id=\"header-slot\" name=\"header\"></slot></div>\n        <iron-icon icon=\"chevron-right\" id=\"post-scroll\" class=\"scroller\" on-tap=\"_postScroll\"></iron-icon>\n      </div>\n      <div id=\"content\"><slot name=\"content\"></slot></div>\n      <slot name=\"mask\"></slot><!--syarat masking 2-->\n    "]);_templateObject_1ebf8330995811e997b8915918243d9d=function _templateObject_1ebf8330995811e997b8915918243d9d(){return data};return data}/**
...
return tabId==data};return this._getLightDOM(this.lastElementChild,!1,fCheck)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_1ebf8330995811e997b8915918243d9d())}}]);return BrownTabDesktop}((0,_brownTabBehavior.BrownTabBehavior)((0,_brownMaskBehavior.BrownMaskBehavior)(//syarat masking 1
