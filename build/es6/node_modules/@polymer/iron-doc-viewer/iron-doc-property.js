...
class, etc.
*/Polymer({is:"iron-doc-property",properties:{descriptor:{type:Object},_privacy:{type:String,computed:"_computePrivacy(descriptor)"},/**
     * Unique anchor ID for deep-linking.
     */anchorId:{type:String,reflectToAttribute:!0,value:""}},_computePrivacy:function(descriptor){if(!descriptor||!descriptor.privacy||"public"===descriptor.privacy){return""}return descriptor.privacy}});