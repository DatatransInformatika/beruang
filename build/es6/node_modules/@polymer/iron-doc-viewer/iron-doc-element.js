...
`,is:"iron-doc-element",behaviors:[IronDocViewerBehavior],properties:{title:{computed:"_computeTitle(descriptor)",notify:!0}},_superclassUrl:function(superclass){if("HTMLElement"===superclass){return"https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement"}return this.baseHref+"/mixins/"+superclass},_superclassTarget:function(superclass){if("HTMLElement"===superclass){return"_blank"}return""},_computeTitle:function(descriptor){return descriptor&&"Element "+this._getElementName(descriptor)}});