...
*/import"../polymer/polymer-legacy.js";import{PaperRippleBehavior}from"../paper-behaviors/paper-ripple-behavior.js";import{Polymer}from"../polymer/lib/legacy/polymer-fn.js";import{html}from"../polymer/lib/utils/html-tag.js";import{afterNextRender}from"../polymer/lib/utils/render-status.js";/**
...
*/Polymer({is:"paper-icon-button-light",_template:html`
    <style>
      :host {
    ...
    <slot></slot>
  `,behaviors:[PaperRippleBehavior],registered:function(){this._template.setAttribute("strip-whitespace","")},ready:function(){afterNextRender(this,()=>{// Add lazy host listeners
...
button.addEventListener("focus",this._rippleDown.bind(this));button.addEventListener("blur",this._rippleUp.bind(this))})},_rippleDown:function(){this.getRipple().uiDownAction()},_rippleUp:function(){this.getRipple().uiUpAction()},/**
   * @param {...*} var_args
   */ensureRipple:function(var_args){var lastRipple=this._ripple;PaperRippleBehavior.ensureRipple.apply(this,arguments);if(this._ripple&&this._ripple!==lastRipple){this._ripple.center=!0;this._ripple.classList.add("circle")}}});