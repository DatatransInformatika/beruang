...
}},100);valid=!1}else{var presenter=this._singleton[this._currentPlace];if(presenter){var currentIdx=this._places.indexOf(this._currentPlace),offset=currentIdx-nextIdx;if(0==offset){valid=!1}else if(!presenter.mayLeave()){setTimeout(function(){window.history.go(offset)},100);valid=!1}}}return valid},_popStateHandler:function(e){var place=e.state?e.state.place:null;//window.location.href.split(this._placePrefix)[1];
if(this._validHistoryStep(place)){this._startPresenter(place,!1)}},_setPopStateListener:function(set){if(this._fPopStateHandler){window.removeEventListener("popstate",this._fPopStateHandler)}if(set){this._fPopStateHandler=this._fPopStateHandler||this._popStateHandler.bind(this);window.addEventListener("popstate",this._fPopStateHandler)}}}}();window.BeruangPlace._setPopStateListener(!0);