...
*/import{html,PolymerElement}from"../../@polymer/polymer/polymer-element.js";class BlackField extends PolymerElement{static get template(){return html`
      <style>
        :host {
          display:none;
        }
      </style>
    `}static get properties(){return{key:{type:String},value:{type:String},type:{type:Number/*1: integer, 2: string*/}}}ready(){super.ready();this.setAttribute("slot","field")}}window.customElements.define("black-field",BlackField);