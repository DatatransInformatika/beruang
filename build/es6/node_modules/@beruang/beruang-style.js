...
*/import"../@polymer/iron-flex-layout/iron-flex-layout.js";const beruangStyle=document.createElement("dom-module");beruangStyle.innerHTML=`<template>
    <style>
		:host([fit-parent]) {
			@apply --layout-fit;
		}
    </style>
  </template>`;beruangStyle.register("beruang-style");