...
*/let internalBeruangBehavior=base=>class extends base{static get properties(){return{/** Fully occupies parent element client area.
			@type{Boolean}
			*/fitParent:{type:Boolean,value:!1,reflectToAttribute:!0}}}ready(){super.ready();this.dispatchEvent(new CustomEvent("beruang-ready"))}};export const BeruangBehavior=dedupingMixin(internalBeruangBehavior);