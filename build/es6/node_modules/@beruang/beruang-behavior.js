...
*/import{dedupingMixin}from"../@polymer/polymer/lib/utils/mixin.js";let internalBeruangBehavior=base=>class extends base{static get properties(){return{fitParent:{type:Boolean,value:!1,reflectToAttribute:!0}}}ready(){super.ready();this.dispatchEvent(new CustomEvent("beruang-ready"))}};export const BeruangBehavior=dedupingMixin(internalBeruangBehavior);