...
*/let internalBrownTabBehavior=base=>class extends base{static get properties(){return{/** Applies left-indent on tab item bar.
			@type{Boolean}
			*/dynamicTab:{type:Boolean,value:!1,reflectToAttribute:!0}}}ready(){super.ready();Gestures.addListener(this,"tap",e=>{//v
...
this._ensureItemVisible(tabItem);this._onTabActiving(tabItem)}});this.addEventListener("active-changed",e=>{//v
