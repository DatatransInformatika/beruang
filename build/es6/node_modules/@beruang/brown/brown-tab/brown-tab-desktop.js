import{html,PolymerElement}from"../../../@polymer/polymer/polymer-element.js";import{GestureEventListeners}from"../../../@polymer/polymer/lib/mixins/gesture-event-listeners.js";import"../../../@polymer/iron-flex-layout/iron-flex-layout.js";import"../../../@webcomponents/shadycss/entrypoints/apply-shim.js";import{BeruangBehavior}from"../../beruang-behavior.js";import{BrownBehavior}from"../brown-behavior.js";import{BrownTabBehavior}from"./brown-tab-behavior.js";import"./brown-tab-style.js";class BrownTabDesktop extends BrownTabBehavior(BrownBehavior(BeruangBehavior(GestureEventListeners(PolymerElement)))){static get template(){return html`
...
return tabId==data};return this._getLightDOM(this.firstElementChild,!0,fCheck)}}window.customElements.define("brown-tab-desktop",BrownTabDesktop);