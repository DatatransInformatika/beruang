...
@customElement
@polymer
*/class BrownTabDesktop extends BrownTabBehavior(BrownResizeMonitorBehavior(BrownMaskBehavior(//syarat masking 1
...
return tabId==data};return this._getLightDOM(this.lastElementChild,!1,fCheck)}_onResizeMonitor(event){this._evaluateScroll()}}window.customElements.define("brown-tab-desktop",BrownTabDesktop);