...
@customElement
@polymer
*/class BrownTabDynamicDesktop extends BrownTabBehavior(BrownBehavior(BeruangBehavior(GestureEventListeners(PolymerElement)))){static get template(){return html`
