...
@customElement
@polymer
*/class BrownTabDynamicDesktop extends BrownTabBehavior(BrownResizeMonitorBehavior(BrownMaskBehavior(//syarat masking 1
...
}))}_onResizeMonitor(event){this._evaluateScroll()}}window.customElements.define("brown-tab-dynamic-desktop",BrownTabDynamicDesktop);